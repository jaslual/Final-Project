...
# you can search books based on subject (genre) by doing "GET /subjects/love.json", which should return books of the subject 'love',
# but more specifically, use https://openlibrary.org/subjects/love.json?published_in=2010-2015
